<?php
/*
Template Name: Каталог оборудования первая страница
*/
?>
<?php 
...
/* breadcrumb Yoast */
		...
		?>
				...
				<div class="title rel fw4 mb tal">Каталог<span class="fwb"> с ценами</span>
					<div class="fl-dot"></div>
				</div>
				<div class="small-text-med small-text mb">
                    <b class="fw7">Скачайте бесплатный каталог</b><br>
                    с ценами на весь ассортимент
				</div>
